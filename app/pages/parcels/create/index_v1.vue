<template>
  <div
    class="p-1 sm:p-8 flex flex-col lg:flex-row gap-12 relative mb-10 sm:mb-1"
  >

    <div class="w-full lg:w-2/5 space-y-4">
      <div
        class="overflow-hidden rounded-xl border border-[#f4a261]/40 bg-[#f4a261]/10 text-[#5a3210] shadow-sm mb-12"
      >
        <div
          class="px-2 sm:px-4 py-2 cursor-pointer select-none flex justify-between items-center"
          @click="showInstructions = !showInstructions"
        >
          <h3 class="font-semibold small text-[#f4a261] text-md">
            {{ t("instructions") }}
          </h3>
          <i
            :class="
              showInstructions ? 'bx bx-chevron-up' : 'bx bx-chevron-down'
            "
          ></i>
        </div>
        ...
        <transition name="fade">
          <ul
            ...
            class="list-disc list-inside small text-sm space-y-1 px-2 sm:px-4 pb-2"
          >
      ...
      <form class="space-y-4">
        <div class="space-y-4 rounded">
          <h2
            class="text-2xl sm:text-3xl font-extrabold text-[#222831] mb-4 hidden"
          >
            {{ t("titlesaveparcel") }}
          </h2>
    ...
    <div
      class="w-full lg:flex-1 bg-gray-200 rounded shadow-md h-[350px] sm:h-[400px] lg:h-auto overflow-hidden z-40"
    >
