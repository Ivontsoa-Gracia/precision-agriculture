<template>
  ...
  <transition name="fade">
    <div 
      ...
      :class="['fixed top-5 left-1/2 transform -translate-x-1/2 px-6 py-3 rounded-lg shadow-lg text-white font-semibold z-50', 
...
// --- Mettre à jour le polygone et surface ---
...
// --- Supprimer dernier point (optionnel) ---
...
onMounted(async () => {
  ...
  L.control.layers({ Satellite: satellite, 'Street Map': streets, 'Topographic Map': topo }).addTo(map)

  // --- Ajouter point au clic et mettre à jour polygon ---
  map.on('click', (e: any) => {
