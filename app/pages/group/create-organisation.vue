  ...
  <div class="flex flex-col gap-4 h-full">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <textarea
        ...
        rows="5"
        class="w-full border border-gray-300 rounded px-3 py-2 h-full focus:outline-none outline-none resize-none"
      ></textarea>
    </div>
  </div>
  ...
  <div class="flex flex-col gap-4 h-full">
    <div class="flex-1 flex flex-col">
      ...
      <input
        ...
        type="text"
        maxlength="255"
        class="w-full border border-gray-300 rounded px-3 py-2 h-full focus:outline-none outline-none"
      />
    </div>
    ...
    <div class="flex-1 flex flex-col">
      ...
      <div class="pt-4">
        <button
          type="submit"
          :disabled="loading"
          class="w-full bg-[#10b481] text-white py-2 px-4 rounded hover:bg-[#10b481] transition disabled:opacity-50"
        >
