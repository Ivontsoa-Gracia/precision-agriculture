    ...
    <section class="bg-gray-50 py-20">
      <div class="max-w-7xl mx-auto px-6 text-center">
        ...
        <p class="text-gray-600 mb-12">
          De l’agriculteur individuel à la grande coopérative, Smart Saha vous accompagne vers une agriculture intelligente et durable.
        </p>
          ...
          >
            <div>
              ...
              <p class="text-3xl font-bold mb-4 text-gray-800">
                {{ plan.price }}
                <span v-if="plan.limit" class="text-sm text-gray-500">({{ plan.limit }})</span>
              </p>
        ...
        <p class="text-gray-500 mt-12">
          💬 Vos données vous appartiennent — vous pouvez les modifier ou les supprimer à tout moment.
        </p>
      </div>
    </section>
  </template>
